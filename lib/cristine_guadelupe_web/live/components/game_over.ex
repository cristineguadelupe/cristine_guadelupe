defmodule CristineGuadelupeWeb.Components.GameOver do
  use CristineGuadelupeWeb, :live_component

  def render(assigns) do
    ~L"""
    <svg id="Layer_1" data-name="Layer 1" width="200" height="400" x="60" y="0"
    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 270.12 214.78">
      <defs>
        <style>
          .cls-go-1, .cls-go-2, .cls-go-3, .cls-go-4, .cls-go-5, .cls-go-6, .cls-go-7 {
            fill-rule: evenodd;
          }
